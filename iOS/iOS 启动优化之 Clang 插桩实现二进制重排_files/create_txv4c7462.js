...
if(e.link){
var i=e.link.replace("#wechat_redirect","&subscene=159&subscene="+window.source+"&scenenote="+encodeURIComponent(window.location.href)+"#wechat_redirect");
...
itemidx:window.parseInt(window.idx,10)||0,
scene:window.parseInt(window.source,10)||0
},P=!1,z=void 0,A=void 0,E=void 0,B=void 0,N=!1,M=[],U={},O=0,H=Date.now(),W=[],Y=null,q="",G=!1,K=!1,V=!1,Q={
commentCount:"",
scrollCount:0,
nickName:"Me",
headImg:"",
...
cmtList:null,
myList:null
},Z=100,J=location.href,X=y.is_wxwork,$=o.os.pc&&!X,et="comment_editing",tt="my_comment_empty_data",nt=navigator.userAgent.indexOf("MicroMessenger")>-1,ot=w.getId("js_cmt_area"),it=J.indexOf("vconsole=1")>0||document.cookie&&document.cookie.indexOf("vconsole_open=1")>-1,mt=w.getId("activity-name")||"";
mt&&(mt=w.trim(mt.innerText)||""),window.pageCommentReportData&&window.pageCommentReportData.idkey&&(it&&console.log("init reportData"),
...
nt||(ot&&(ot.style.display="none"),Q.commentId=0),it&&console.info("[Comment on Article] Comment ID:",Q.commentId);
var st=function(){
return y.isWechat?o.os.ipad?0:y.isInMiniProgram?0:C.canUseKeyboard?2:(y.isIOS||y.isAndroid)&&(y.gtVersion("7.0.8")||s.isNativePage())?1:0:0;
}(),at=function(e,t){
...
2>O||[Q.myList.getItemList(),Q.cmtList.getItemList()].forEach(function(e,t){
...
return function(m,s){
if(e&&window.goContentId&&!s&&m)if(!window.onload_endtime||new Date-window.onload_endtime<1e3){
...
Q.onlyFansDaysCanComment&&0===Q.isFansDays?((t||e).innerHTML="作者已设置关注7天后才可留言",at(e,"block")):Q.onlyFansCanComment&&0===Q.isFans?((t||e).innerHTML="Follow first to comment",
...
0===Q.offset){
Q.headImg=o.logo_url,Q.nickName=o.nick_name,m&&(Q.contentIDs=[]);
var a=o.elected_comment;
a&&a.length?(at(U.main),Q.cmtList.render(a),!X&&ft(w.getId("js_cmt_nofans1")),o.elected_comment_total_cnt<=10&&at(U.statement),
E||"5"!==window.item_show_type||(E=!0,Math.random()<.1&&(t.saveSpeeds({
uin:window.uin,
pid:675,
speeds:[{
sid:27,
...
}),t.send())),G=!0,gt(m,s)):(ct(U.main),ft(w.getId("js_cmt_nofans2"),w.getId("js_cmt_nofans2_inner")));
...
if(!(N||-1===Q.offset||Q.offset>0&&d-m-R>500)){
...
it&&console.info("[Comment on Article] Request comment data:",r),l("[Appmsg comment] start get comment data, url:"+r),
c({
url:r,
dataType:"json",
success:function(e){
...
var t=e.content,n=e.successBegin,o=e.successEnd,m=e.complete;
z!==t&&(H=Date.now());
var s=i.join("/mp/appmsg_comment",{
action:"addcomment",
scene:Q.reportData.scene,
appmsgid:window.appmsgid,
idx:window.idx,
...
case 0:
window.weui.toast("Commented",750);
var i={
content:t,
nick_name:Q.nickName,
...
case-10:
window.weui.alert("600 characters max");
break;
...
default:
z=t,window.weui.alert("System error. Try again later.");
}
0!==Number(e.ret)&&lt(Q.reportData.addCommentErr,"type:resperr;url:"+encodeURIComponent(s)+";ret="+e.ret);
},
error:function(e){
console.log(e),lt(Q.reportData.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(s));
},
complete:m
});
},jt=function(){
...
0===O&&(O=1,Array.prototype.forEach.call(U.myCmtLoading,at),c({
url:e,
dataType:"json",
success:function(t){
...
K=!0,gt(!0,!1);
}else O=0,lt(Q.reportData.errComment,"type:resperr;url:"+encodeURIComponent(e)+";ret="+n);
},
error:function(){
O=0,lt(Q.reportData.errComment,"type:ajaxerr;url:"+encodeURIComponent(e));
},
complete:function(){
...
V=!0,C.canUseCancel&&(U.addBtn.classList.add(e),U.cmtWritePlaceholder.innerHTML="正在输入...");
},
leaveEditing:function(){
V&&(V=!1,C.canUseCancel&&(U.addBtn.classList.remove(e),U.cmtWritePlaceholder.innerHTML="写下你的留言",
...
return P=!0,B=s.getScrollTop(),st&&e?void(1===st&&Rt()):(!$&&ct(U.article),Q.myList.changeContainer(U.mylistOld),
...
case 0:
default:
if(s.isNativePage()||document.body.classList.add(et),n)return it&&console.log("FakeHash on comment"),
void xt();
...
if(a.on(window,"scroll",e),e(),s.bindDebounceScrollEvent(_t),$)a.tap(U.inputPC,function(){
ct(U.inputPC),Y.show(U.inputPC);
});else switch(a.tap(U.cmtWrite,Ft),st){
case 2:
...
e.preventDefault(),Tt(),ct(U.fakebar);
...
isWxWork:X
},!1)),$?document.body.classList.add("pages_skin_pc"):0===st&&document.body.insertAdjacentHTML("beforeend",d.tmpl(u,{
...
}),window.cl=Q.cmtList,window.ml=Q.myList,0===st&&window.__second_open__&&o.os.ios&&(U.mine.style.marginBottom=getComputedStyle(U.fakebar).height),
...
if(e&&e.length){
g("js_like_wording").textContent="Wow",g("js_parise_wording").textContent="Like";
...
("100k+"!==e||"100k+"!==e)&&(j.likeNumDom.innerHTML=a(j.likeNum)),j.likeNumDom.style.display="",
p&&p.render&&p.render("praise");
},D=function(){
s.removeClass(j.likeDom,"praised"),j.likeNum--;
var e=j.likeNumDom.innerHTML;
j.likeNum>=0&&"100k+"!==e&&"100k+"!==e&&(j.likeNumDom.innerHTML=a(j.likeNum)),0===j.likeNum&&(j.likeNumDom.style.display="none");
},y=[],B=function(e){
"function"==typeof e&&y.push(e);
},N=function(e){
j.isLike=j.isLike?0:1,j.isLike?b():D(),l({
...
return j.likeBottomBtn&&j.likeBottomBtn.disabled===!0?void 0:window.is_temp_url?void("5"!==window.item_show_type||!c.isNativePage()||_.os.pc?window.weui.alert("Unable to do this in preview"):n("Unable to do this in preview")):void N(e);
};
t.on(j.likeDom,"click",function(){
return z();
}),t.on(j.shareDom,"click",function(){
j.shareBottomBtn&&j.shareBottomBtn.disabled===!0||(v(),r.invoke("handleMPPageAction",{
action:"share"
}));
}),t.on(j.collectDom,"click",function(){
r.invoke("handleMPPageAction",{
action:"doFavorite"
}),p&&p.render&&p.render("favorite"),k.shareReport({
...
var L=function(){
f(),d.onFontScaleChange(f),window.addEventListener("resize",f);
},I=function(e){
