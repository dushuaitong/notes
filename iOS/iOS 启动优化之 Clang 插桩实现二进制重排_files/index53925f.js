...
function C(e){
try{
for(var c=window.pageYOffset||document.documentElement.scrollTop,m=0;m<K.length;m+=H){
var g=K[m];
if(!(g.offsetTop>c+x.getInnerHeight()+100)){
var u=w.attr(g,"data-cpsstatus");
if("hide"==u){
g.setAttribute("data-cpsstatus","loading");
for(var f=""+m,y=1,v=m+1;v<K.length&&m+H>v;v++)f=f+"%2c"+v,y++;
...
"list"==Q?K[F].innerHTML=n.tmpl(s,J,!1):"banner"==Q?K[F].innerHTML=n.tmpl(r,J,!1):"card"==Q&&(K[F].innerHTML=n.tmpl(a,J,!1));
}
}catch(Y){
console.log(Y);
}
...
var $=void 0,X=null;
if(R(),h.on(window,"scroll",R),C(),h.on(window,"scroll",q),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")){
window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
var Z=void 0;
Z=_.isIOS?window.cdn_url_1_1||window.cdn_url_235_1||window.msg_cdn_url:window.cdn_url_1_1||window.cdn_url_235_1,
T.init({
...
if(!i){
if(!e&&u)return;
if((_.is_wxwork||!_.isWechat)&&!e)return void window.weui.alert("Make the payment in Weixin.");
u=!0,f=new Date;
}
var n=o.currentTarget;
if(!e&&1*n.dataset.ready===0)return!i&&P.show("Generating order..."),new Date-f>6e4?(P.hide(),
window.weui.alert("Payment timeout. Try again later."),void(u=!1)):setTimeout(b,100,{
currentTarget:n
},!0);
...
default:
k.report110809(14),window.weui.alert("Order creation failed. Try again later.");
}
},
error:function(){
...
{
var st=!_.isWp&&-1==navigator.userAgent.indexOf("MicroMessenger");
-1!=navigator.userAgent.indexOf("WindowsWechat");
}
e("appmsg/share.js");
var dt=v(1e3*parseInt(window.modify_time)),pt=dt.format("YYYY-MM-DD"),ct=document.getElementById("js_modify_time");
if(ct&&(ct.innerHTML=pt),window.isSg||"mp.weixin.qq.com"==location.host){
var mt=e("biz_common/log/jserr.js");
mt({
key:0,
...
var lt=-1!=navigator.userAgent.indexOf("TBS/"),wt=function(e,t){
D(e,function(e,o){
...
lt&&1>=n&&(i.lossy=i.lossless=i.alpha=1,window.logs.webplog=i);
...
t.err_msg.indexOf(":ok")>-1?(U=t.serverUrl,window.__addIdKeyReport("28307",117)):t.err_msg.indexOf(":fail")>-1&&window.__addIdKeyReport("28307",118),
e();
})):e();
},ut=function(e){
wt("lossy",e),wt("lossless",e),wt("alpha",e),wt("animation",e);
};
window.webp=!1,gt(function(){
ut(function(t){
function o(e){
...
var i=e.__retryload;
return i=0,t=t.https2http(),e.__retryload=i,e.src=at.addParam(t,"retryload",i,!0),
!1;
};
h.on(e,"click",i);
}
...
w&&(g||f)?(o=at.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=at.addParam(o,"tp","webp",!0),
window.__addIdKeyReport("28307",84)),o=at.addParam(o,"wxfrom","5",!0),is_https_res||W?(o=o.http2https(),
...
return U&&(v||b)&&(window.__addIdKeyReport("28307",106),o=at.addParam(o,"tp","wxpic",!0),
o=U+"hevc?url="+encodeURIComponent(o)+"&type="+o.getOriginImgType()),"anonymous"==e.crossOrigin&&(o=at.addParam(o,"wx_co","1",!0)),
window.logs.img.load[o]=!0,m("[Appmsg] image_load_event_change_src. originsrc:"+t+"  ^^^ newsrc : "+o),
e.start_load_time=+new Date,e.alt="Image",o;
},
...
mid:"mmbizwap:imgMonitor",
view:"wap_appmsg"
}),U&&e.indexOf(U)>-1&&window.__addIdKeyReport("28307",108),s>o){
...
e.indexOf(!1)&&(e=e.http2https())),U&&e.indexOf(U)>-1){
var r=e.split("hevc?url=")[1];
r=r.split("&type")[0],r=decodeURIComponent(r),r=r.replace("tp=wxpic",""),e=r.https2http();
}
t.start_load_time=+new Date,t.src=at.addParam(e,"retryload",o,!0);
}
...
1>=r&&window.__addIdKeyReport("28307",87+1*r)),U&&e.indexOf(U)>-1&&window.__addIdKeyReport("28307",107),
...
var _t=e("appmsg/copyright_report.js");
!function(){
...
return c.hasClass(e,"rich_media_meta_link")?window.is_temp_url?(window.weui.alert("Unable to do this in preview"),
...
e("appmsg/qqmusic.js");
var At=e("appmsg/voice.js"),jt=[];
if(voiceList&&voiceList.voice_in_appmsg&&voiceList.voice_in_appmsg.length>0&&(jt=voiceList.voice_in_appmsg),
At.init(jt),e("redpackage/redpacketcover.js"),e("appmsg/search/search.js"),e("appmsg/poi/poi.js"),
...
var It=e("question_answer/appmsg.js");
It.renderQaCard&&It.renderQaCard({
mid:window.mid,
idx:window.idx,
...
var Et=e("appmsg/appmsg_copy_report.js");
new Et({
biz:window.biz,
...
if(_t.card_pv_report(),Math.random()<.01)try{
...
n.offsetTop<s&&(r=!0,S.setSum(59977,15,1));
}
});
}
...
S.setSum(28307,18,1),_.isIOS&&S.setSum(28307,19,1),_.isAndroid&&S.setSum(28307,20,1);
},!1);
}(),function(){
...
var kt=Math.random();
if(2e-4>kt)try{
for(var Pt=document.getElementsByTagName("img"),zt=window.screen.height,Bt=window.screen.width,Tt=0,St=window.devicePixelRatio,Tt="",F=0,Rt=Pt.length;Rt>F;F++){
var Ct=Pt[F].getAttribute("data-src");
if(Ct){
var Ot=Pt[F].getBoundingClientRect();
Tt+=Bt+"|"+zt+"|"+Ot.left.toFixed(2)+"|"+(Bt-Ot.right).toFixed(2)+"|"+Ot.width.toFixed(2)+"|"+St.toFixed(2)+"|"+Ct+";";
}
}
l({
...
e("appmsg/popup_report.js")),k=e("appmsg/pay_report_utils.js"),P=e("appmsg/loading.js"),z=-1,B=e("appmsg/finance_communicate.js"),T=e("appmsg/topbar.js"),S=e("biz_wap/utils/jsmonitor_report.js"),R=e("appmsg/getForbidConfig.js"),C=e("appmsg/set_article_read.js"),O=C.setArticleRead,N=!1;
...
var L=window.user_uin||0,K=Math.floor(L/100)%1e3,W=0!==L&&1001>K,V=!0,U="",H=5;
