...
s="https://mp.weixin.qq.com/mp/author?action=show&__biz="+biz+"&appmsgid="+mid+"&timestamp="+e.timestamp+"&author_id="+T.author_id+"&idx="+idx+"&scene="+T.authorPageScene+"&rscene="+T.authorPageRscene+"&from_scene="+window.source+"&from_subscene="+window.subscene+"&from_enterid="+window.enterid+"&from_sessionid="+window.sessionid+"&is_fans="+e.isFans,
e.rewardsn&&(s+="&rewardsn="+e.rewardsn),s+=a,-1==navigator.userAgent.indexOf("Android")||T.author_id||(s="https://mp.weixin.qq.com/bizmall/reward?act=showpage&__biz="+biz+"&appmsgid="+mid+"&idx="+idx+"&sn="+sn+"&timestamp="+e.timestamp+"&showwxpaytitle=1&rewardsn="+e.rewardsn+a);
...
if(W=o(s.replace(a,"&__tc=1"+a),x),C=o(s,x),m.on(u,"click",W),T.author_id&&1==e.can_reward&&v&&m.on(v,"click",C),
...
var t=document.getElementById("js_reward_pagination"),n=t.getElementsByClassName("js_reward_pagination_curpage")[0],a=Math.ceil(e.reward_total/z),d=1,o=!0,s=document.getElementById("js_reward_list"),c=function(t,n){
for(var r=(t-1)*z,i=o?3*p:0,d=document.createDocumentFragment(),c=r+i,l=t===a?e.reward_total:t*z;l>c;c++)w(d,n?window.defaultAvatarUrl:A[c]);
return!o&&(s.innerHTML=""),s.appendChild(d),o=!1,n?function(){
for(var e=s.getElementsByClassName("reward_user_avatar"),t=i,n=e.length;n>t;t++)e[t].firstElementChild.src=A[r+t];
}:!1;
};
...
S=function(t){
s.style.height="fold"===t?3*l+"px":a>d?l*Math.ceil(z/p)+"px":l*Math.ceil(e.reward_total%z/p)+"px";
...
a>1&&i(t),S("fold")):(1===d&&o&&_(d),E.reward.classList.add("reward_avatar_unfold"),
a>1&&r(t),S("unfold"));
...
for(var d=0,o=t.length;o>d&&(a++,w(r,t[d]),i||a!==3*p)&&a!==(z||16*p);++d);
...
t=o>H&&0>=a?!1:H>o&&a+r>=i?!1:!0,t||e.preventDefault();
}
},K=function(){
...
T.sendLock=!1,I.hide(),t&&t.base_resp&&0===t.base_resp.ret?(s(),q(),weui.toast("Posted",1e3)):d(e.length);
},
error:function(){
...
}),m.on(E.whisperDialogHide,"mousedown",s),m.on(E.whisperDialogMask,"mousedown",s),
...
}),m.on(E.whisperSend,"mousedown",o);
};
return{
handle:function(e,t){
p=t,u(e),1==e.can_reward&&T.author_id&&E.reward&&U(e.isFans),s(e);
},
render:function(e){
p=e,c(!0);
},
