...
var t=e("biz_wap/jsapi/core.js"),n=e("appmsg/i18n.js"),i=e("biz_common/utils/url/parse.js"),o=e("biz_wap/utils/ajax.js"),a=e("appmsg/retry_ajax.js"),r=e("biz_common/dom/event.js"),l=e("pages/utils.js"),s=e("common/utils.js"),c=e("biz_wap/utils/openUrl.js"),m=e("common/keyboard.js"),p=e("common/actionSheet.js"),d=e("biz_wap/utils/jsmonitor_report.js"),u=e("biz_common/tmpl.js"),y=e("appmsg/comment/comment_list/comment_item.html.js"),_=e("appmsg/comment/comment_list/item.html.js"),g=e("biz_wap/utils/mmversion.js"),f=g.is_wxwork,h=g.isWechat,v=h&&!f,D=e("biz_wap/utils/device.js"),b=D.os.pc&&!f,k=e(b?"appmsg/emotion/emotion_pc.js":"appmsg/emotion/emotion.js"),w=e("appmsg/comment/comment_input/comment_input.js"),L=e("pages/scrollY.js"),C=e("appmsg/comment/comment_report.js"),I=C.report22215,j="praised",R="js_item",T="js_comment_item",P="js_reply_item",x="js_comment_praise",S="js_reply_praise",M="praise_num",E="js_comment_del",H="js_reply_del",z="js_comment_main",N="js_extend_comment",A="discuss_media_active",B="js_can_reply",O="js_comment_reply_pc",K="js_reply_reply_pc",q="js_input_pc",F="js_dropdown",W="js_comment_complain",V="js_reply_complain",U="commenting",Y="openning",Q="comment_primary_input_multiline",G=2,X=s.getInnerHeight(),Z=g.isAndroid&&m.canUseCancel,$=l.getId("activity-name")||"";
$&&($=l.trim($.innerText)||"");
var J=function(e){
...
document.body.appendChild(t),r.on(t,"click",function(){
...
var t=document.createElement("div");
return t.innerHTML=e,Array.prototype.forEach.call(l.qsAll("div.discuss_message_content",t),function(e){
e.innerHTML=k.encode(e.innerHTML);
}),Array.prototype.forEach.call(l.qsAll("p.js_to_content",t),function(e){
e.innerHTML=k.encode(e.innerHTML);
}),t;
},rt=function(){
var e=null,t=null,n=null;
return function(i){
e||(e=l.getId("js_warning_toast"),t=l.qs(".js_content",e)),t.innerHTML=i,n?clearTimeout(n):e.style.display="",
...
this.inputInitHeight=0,this.inputInitWidth=0,this.inputValue={},this.input=b?new w({
type:"reply",
...
r.on(document,"click",function(e){
t.openningDropdown&&!l.isParent(e.target,t.openningDropdown)&&o();
},!1);
var a=function(e){
var n=e.e,i=e.el;
...
var i=n.e,o=n.el,a=n.cmtData,r=n.replyData;
o.classList.contains(B)&&(i.preventDefault(),t.commentReply(e,o,a,r));
};
...
ReplyId:"reply"===e?r.reply_id:0
}),t.showActionSheet(e,a,r),o.classList.remove(A),i.preventDefault();
};
...
t.classList.contains(B)&&t.classList.add(A),d=null;
},100);
};
...
var _=function(e){
var t=e.el;
d?(clearTimeout(d),d=null):t.classList.remove(A);
};
...
t.classList.remove(A),d&&(clearTimeout(d),d=null);
},200);
};
...
return g(e);
}),s)),r.on(document,"contextmenu",function(e){
u&&l.isParent(e.target,u)&&(e.preventDefault(),tt());
...
this.container.innerHTML=at(this.getReplyListHTML(e,t)).innerHTML),this.itemList=Array.prototype.slice.call(l.qsAll("."+R,this.container)),
...
key:"add",
value:function(e){
var t=this,n=e.data,i=e.mode,o=void 0===i?"push":i,a=e.type,r=void 0===a?"comment":a,s=e.cmtData,c=e.contentId,m=e.myId,p=e.pos,d=void 0,u=void 0,y=void 0,_=void 0,g=void 0;
"comment"===r?(d="getCommentListHTML",u="content_id",y=this,_="data",g=this.container):(d="getReplyListHTML",
u="reply_id","reply"!==this.type?(s||(s=this.getData(void 0!==c?{
contentId:c
}:{
myId:m
})),s&&(y=s.reply_new,_="reply_list",g=l.qs(".js_reply_list",this.getComment(s.content_id).parentNode))):(s||(s=this.cmtData),
s&&(y=this,_="data",g=this.container))),g&&!function(){
var e=y[_],i=0;
p&&!e.some(function(e){
return i++,e[u]===p;
})&&(i=-1);
...
if(i>0&&i<e.length){
if(e[i][u]!==n[0][u]){
var l=t.getItemFrag(d,n,s),c=l.frag,m=l.itemList,f="comment"===r?t.getCommentIdx(p):t.getReplyIdx(s.content_id,p);
...
var v=t.getItemFrag(d,n,s),c=v.frag,m=v.itemList,f="comment"===r?t.getCommentIdx(p):t.getReplyIdx(s.content_id,p);
...
a&&"function"==typeof t.onAdd&&t.onAdd(n,o,r,s?s.content_id:"",p);
}();
}
},{
key:"remove",
value:function(t){
var n=this,i=t.type,o=void 0===i?"comment":i,a=t.cmtData,r=t.replyData,l=t.contentId,s=t.replyId,c=t.myId;
a||(a=this.getData(void 0!==l?{
contentId:l
}:{
myId:c
})),a&&!function(){
var t=void 0,i=void 0,l=void 0,c=void 0;
if("comment"===o?(t=n.data,i="content_id",l=a.content_id,c=n.getCommentIdx(a.content_id)):("reply"!==n.type?t=a.reply_new.reply_list:(a=n.cmtData,
t=n.data),r||(r=e.getDataByKey(t,"reply_id",s)),r&&(i="reply_id",l=r.reply_id,c=n.getReplyIdx(a.content_id,r.reply_id),
...
success:function(){
n.globalData.cmtDialog.removeReply(r.reply_id);
},
cmtData:a
}))),l){
var m=-1;
if(t.some(function(e,t){
return e[i]===l?(m=t,!0):!1;
}),m>-1){
n.count--;
...
key:"getData",
value:function(t){
var n=t.type,i=void 0===n?"comment":n,o=t.contentId,a=t.replyId,r=t.myId;
if("reply"===this.type)return"comment"===i?this.cmtData:e.getDataByKey(this.data,"reply_id",a);
var l=void 0;
return l=void 0===o?e.getDataByKey(this.data,"my_id",r):e.getDataByKey(this.data,"content_id",o),
"comment"===i?l:e.getDataByKey(l.reply_new.reply_list,"reply_id",a);
}
},{
key:"getItemList",
value:function(){
...
key:"setLikeInfo",
value:function(t){
var n=t.type,i=void 0===n?"comment":n,o=t.cmtData,a=t.replyData,r=t.contentId,s=t.replyId,c=t.myId,m=t.likeStatus,p=t.likeNum,d=t.force;
if(o||(o=this.getData(void 0!==r?{
contentId:r
}:{
myId:c
})),o){
...
"number"!=typeof p&&(p=u[_]+(m?1:-1)),u[_]=p,e.changeLikeStatus("comment"===i?l.qs("."+x,this.getComment(o.content_id)):l.qs("."+S,this.getReply(o.content_id,a.reply_id)),m,p),
...
if(a){
var r=l.qs(".js_more_reply",a.parentNode);
r&&(r.style.display=0===t||t===n.reply_new.reply_list.length?"none":"",l.qs(".js_reply_length",r).innerHTML=t);
}
}
}
},{
...
var a=o.nick_name+o.content,r=!1,l=t.globalData.reportData.repeatContentID;
n[a]&&(r=!0,l=t.globalData.reportData.repeatContent),t.globalData.contentIDs.indexOf(o.content_id)>-1&&(r=!0,
l=t.globalData.reportData.repeatContentID),t.globalData.contentIDs.push(o.content_id),
n[a]=!0,r&&t.myReport(l,encodeURIComponent(JSON.stringify({
...
var r=a[0];
1===r.nodeType&&o.push(r.classList.contains(R)?r:l.qs("."+R,r)),i.appendChild(r);
}
return{
frag:i,
itemList:o
...
i),n);
var a=Object.keys(n);
r.on(this.container,t,function(t){
for(var i=t.target,r="",l=function(e){
return 1===i.nodeType&&i.classList.contains(e)?(r=e,!0):!1;
};i&&i!==t.currentTarget&&!a.some(l);)i=i.parentNode;
if(r&&"function"==typeof n[r]){
...
"comment"===e?(r=t.like_status?0:1,l=t.like_num+(t.like_status?-1:1),i+="likecomment",
o.appmsgid=window.appmsgid):(r=n.reply_like_status?0:1,l=n.reply_like_num+(n.reply_like_status?-1:1),
...
"comment"===e?r.action="delete":(r.action="deletecommentreply",r.reply_id=n.reply_id),
o({
url:i.join("/mp/appmsg_comment",r,!0),
dataType:"json",
success:function(i){
0===i.ret?a.remove({
type:e,
cmtData:t,
replyData:n
}):J("Deletion failed. Try again.");
},
error:function(){
J("Network error. Try again.");
}
});
}
}]
...
var r="comment"===e&&i.is_from_me||"reply"===e&&i.is_from_me&&(1===o.is_from||2===o.is_from);
if(2===it)!function(){
var t=void 0,r=void 0;
"comment"===e?(t=""+i.content_id,r=i.nick_name):(t=i.content_id+"_"+o.reply_id,r=o.nick_name),
...
disableScroll:s||Z,
text:a.inputValue[t]||"",
placeholder:a.globalData.canC2CReply?"回复 "+r+"：":"回复被精选后，对所有人可见",
maxLength:140,
showRemindWordCount:10,
disableScrollAdjustment:s,
scrollContentY:s?0:l.getScrollTop()+n.getBoundingClientRect().bottom+92,
success:function(n){
a.sendReply({
cnt:n,
type:e,
...
"comment"===e?(a=""+i.content_id,r=i.nick_name):(a=i.content_id+"_"+o.reply_id,r=o.nick_name),
this.input.show(l.qs("."+q,n),{
target:t,
renderType:"append",
text:this.inputValue[a],
placeholder:this.globalData.canC2CReply?"回复 "+r+"：":"回复被精选后，对所有人可见",
params:{
type:e,
cmtData:i,
replyData:o,
...
if(1===t)return rt("回复已被关闭"),!1;
if(e.is_from_me)return!0;
if(0===t)rt("作者已设置其他人不能回复");else if(3!==t||this.globalData.isFans){
if(4!==t||this.globalData.isFansDays)return!0;
rt("作者已设置关注7天后才可回复");
}else rt("作者已设置关注后才可以回复");
return!1;
}
},{
key:"sendReply",
value:function(t){
var n=this,i=t.cnt,a=t.type,r=t.cmtData,l=t.replyData,s=t.success,c=e.validContent(i,"reply"),m=c.valid,p=c.content;
...
to_reply_id:"reply"===a?l.reply_id:"",
...
newCnt:++r.reply_new.reply_total_cnt,
cmtData:r
});
var t={
content:p,
...
to_content:"reply"===a?l.content:"",
to_nick_name:"reply"===a?l.nick_name:"",
is_from:1,
to_reply_del_flag:0,
...
return 3600>i?Math.ceil(i/60)+"分钟前":86400>o?Math.floor(i/60/60)+"小时前":172800>o?"Yesterday":604800>o?Math.floor(o/24/60/60)+"天前":r.getFullYear()===a?r.getMonth()+1+"/"+r.getDate():r.getFullYear()+"年"+(r.getMonth()+1)+"月"+r.getDate()+"日";
}
},{
key:"validContent",
value:function(e){
var t=arguments.length<=1||void 0===arguments[1]?"comment":arguments[1];
return e=l.trim(e),b&&(e=e.replace(/<br\/>/g,"").replace(/\n/g,"")||""),e.length<1?(J("comment"===t?"Comment cannot be blank":"回复不能为空"),
{
valid:!1
}):"comment"===t&&e.length>600?(J("600 characters max"),{
valid:!1
}):"reply"===t&&e.length>140?(J("字数不能多于140个"),{
valid:!1
}):{
valid:!0,
content:e
...
define("common/keyboard.js",["biz_wap/jsapi/core.js","biz_common/dom/event.js","biz_wap/utils/mmversion.js","pages/bottom_input_bar.js"],function(e){
"use strict";
var t=e("biz_wap/jsapi/core.js"),n=e("biz_common/dom/event.js"),o=e("biz_wap/utils/mmversion.js"),i=e("pages/bottom_input_bar.js"),s=!1,c=!1,r=!1;
if(o.isIOS&&o.gtVersion("7.0.16"))s=!0,c=!0,r=!0;else if(o.isAndroid){
var l=o.getInner();
(o.gtVersion("7.0.18")&&"27001634">l||l>="28000038")&&(s=!0,c=l>="27001700");
}
var a=[],u=null,d=!1,f=null;
s&&(t.on("onGetKeyboardHeight",function(e){
a.length&&a.forEach(function(t){
"function"==typeof t&&t(e.height);
});
}),c&&(u=document.createElement("div"),u.style.cssText="width: 100%; height: 100%; position: fixed; top: 0; background-color: transparent; z-index: 99999999; display: none;",
document.body.appendChild(u),n.on(u,"touchmove",function(e){
d&&e.preventDefault();
})));
var p=function(){
return s?!0:(console.log("Not support keyboard."),!1);
};
return{
canUseKeyboard:s,
canUseCancel:c,
onGetKeyboardHeight:function(e){
p()&&-1===a.indexOf(e)&&a.push(e);
},
...
show:function(e){
if(p()||e.forceFallback||e.forceFallbackIfUnsupport){
if(r||e.forceFallback){
var n=function(){
f||(f=new i);
var t=!1;
return f.addListener("submit",function(){
t=!0,"function"==typeof e.success&&e.success(f.getContent());
}),f.addListener("hide",function(){
var n=f.getContent();
t||"function"==typeof e.cancel&&e.cancel(n),"function"==typeof e.hide&&e.hide(n),
t=!1;
}),f.addListener("show",function(){
"function"==typeof e.show&&e.show();
}),f.addListener("input",function(){
"function"==typeof e.input&&e.input(f.getContent());
}),f.setContent(e.text||""),f.setLimit(e.maxLength||0),f.setPlaceholder(e.placeholder||""),
f.show(),{
v:void 0
};
}();
...
e.scrollContentY&&(o.scrollContentY=e.scrollContentY),e.mask&&u&&(u.style.display=""),
d=!!e.disableScroll,t.invoke("showKeyboard",o,function(t){
u&&(u.style.display="none"),/:ok$/.test(t.err_msg)?"function"==typeof e.success&&e.success(t.text):/:cancel$/.test(t.err_msg)&&"function"==typeof e.cancel&&e.cancel(t.text),
"function"==typeof e.hide&&e.hide(t.text);
}),"function"==typeof e.show&&e.show();
}
},
hide:function(){
