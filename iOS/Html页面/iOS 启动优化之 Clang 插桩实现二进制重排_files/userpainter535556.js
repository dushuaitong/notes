...
function i(){
var e=c("js_content");
return e?(l._oElements=e.getElementsByTagName("mpvoice")||[],l._oElements.length<=0?!1:!0):!1;
}
function o(){
l.musicLen=l._oElements.length;
}
function n(e){
for(var i=0,o=0;o<l.musicLen;o++){
var n=l._oElements[o],a={},c=n.getAttribute("voice_encode_fileid")||"";
try{
c=decodeURIComponent(c);
}catch(d){}
a.voiceid=m.encodeStr(c),a.voiceid=a.voiceid.replace(/&#61;/g,"=").replace(/^\s/,"").replace(/\s$/,""),
a.isaac=1*n.getAttribute("isaac2")||0,a.src=l.srcRoot.replace("#meidaid#",a.voiceid),
...
d&&d.parentNode.removeChild(d),a(i),l.musicList[i.voiceid+"_"+i.posIndex]=i;
}
function a(e){
...
e("biz_common/utils/string/html.js");
var r=e("pages/voice_tpl.html.js"),s=e("appmsg/log.js"),m=e("pages/voice_component.js"),l={
musicList:{},
musicLen:0,
...
g=function(){
return d[E]&&d[E].item_show_type>=0&&s.indexOf("mp.weixin.qq.com")>-1&&(u.isIOS||u.isAndroid)&&!u.isInMiniProgram&&u.isWechat?1==j.getAttribute("clicked")?!1:(l.invoke("openWebViewUseFastLoad",{
url:s,
...
var a=[s,"mpshare=1","scene="+i,"srcid="+srcid,"sharer_sharetime="+n,"sharer_shareid="+l];
""!=o&&a.push(o),s=a.join("&"),t=e.split("?")[0]+"?"+s+"#"+(e.split("#")[1]||"");
}
}catch(r){
t="";
}
...
var o=e("biz_common/utils/url/parse.js"),s=e("biz_wap/utils/mmversion.js"),a=e("appmsg/appmsg_report.js"),r=e("appmsg/malicious_wording.js"),m=e("biz_wap/utils/jsmonitor_report.js"),c=e("appmsg/related_article.js"),l=window.md5(window.user_uin),u=e("biz_wap/jsapi/core.js");
u.call("hideToolbar"),u.call("showOptionMenu");
var _=msg_title.htmlDecode(),h=(msg_source_url.htmlDecode(),""),p=cdn_url_1_1||msg_cdn_url||ori_head_img_url||round_head_img,d=p,g=msg_link.htmlDecode(),_=msg_title.htmlDecode(),f=msg_desc.htmlDecode();
...
d=d.replace(/\/0\?/,"/640?")),malicious_title_reason_id&&(_=r.maliciousTitleMap[malicious_content_type][malicious_title_reason_id]||_,
f=r.maliciousDescMap[malicious_content_type][malicious_title_reason_id]||f,1!=malicious_content_type&&(p="https://mmbiz.qlogo.cn/mmbiz_png/cVgP5bCElFiayFgbgEB9iaDt7hLicfz9RrXGM0LpaQ0TUic2gP7lbbqU3jCD8ibonicgIa3p99yjx1f1P26HChraeRUg/0?wx_fmt=png")),
"1"==is_limit_user&&u.call("hideOptionMenu"),window.is_temp_url&&u.invoke("hideMenuItems",{
...
u.on("menu:share:appmessage",function(e){
if(window.is_wash){
var o=Date.now();
u.invoke("sendAppMessage",{
img_url:w,
img_width:"640",
img_height:"640",
link:i(g,s,o),
...
n(g,fakeid,s,o,e.shareScene);
});
}else{
var s=1,a=t(p,"1");
e&&"favorite"==e.scene&&(s=24,a=t(p,"4"),c&&c.render&&c.render("share")),1==malicious_content_type&&(a="https://mmbiz.qlogo.cn/mmbiz_png/cVgP5bCElFiayFgbgEB9iaDt7hLicfz9RrXGM0LpaQ0TUic2gP7lbbqU3jCD8ibonicgIa3p99yjx1f1P26HChraeRUg/0?wx_fmt=png");
var o=Date.now();
u.invoke("sendAppMessage",{
appid:h,
img_url:a,
...
n(g,fakeid,s,o,e.shareScene),c&&c.render&&c.render("share");
});
}
}),u.on("menu:share:timeline",function(e){
if(window.is_wash){
var o=Date.now();
u.invoke("shareTimeline",{
img_url:w,
img_width:"640",
img_height:"640",
link:i(g,2,o),
...
n(g,fakeid,2,o,e.shareScene),c&&c.render&&c.render("share");
});
}
});
u.on("menu:share:weiboApp",function(){
var e=Date.now();
u.invoke("shareWeiboApp",{
img_url:p,
link:i(g,3,e),
title:_
},function(){
...
}),u.on("menu:share:facebook",function(){
var e=Date.now();
n(g,fakeid,7,e),u.invoke("shareFB",{
img_url:d,
img_width:"640",
img_height:"640",
link:i(g,43,e),
...
}),u.on("menu:share:QZone",function(){
var e=t(p,"6"),o=Date.now();
n(g,fakeid,5,o),u.invoke("shareQZone",{
img_url:e,
img_width:"640",
img_height:"640",
link:i(g,22,o),
...
}),u.on("menu:share:qq",function(){
var e=t(p,"7"),o=Date.now();
n(g,fakeid,5,o),u.invoke("shareQQ",{
img_url:e,
img_width:"640",
img_height:"640",
link:i(g,23,o),
...
}),u.on("menu:share:email",function(){
var e=Date.now();
n(g,fakeid,5,e),u.invoke("sendEmail",{
content:i(g,5,e),
title:_
},function(){});
}),u.on("sys:record",function(){
u.invoke("recordHistory",{
link:g,
title:_,
source:nickname,
img_url:p
