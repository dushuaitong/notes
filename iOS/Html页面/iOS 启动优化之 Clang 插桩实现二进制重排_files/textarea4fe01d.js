...
})):t.state.androidShowingKeybroad?(t.$inputWrapper.css({
opacity:1,
bottom:0,
...
e.height&&"none"!==t.$inputWrapper.css("transform")&&getRealHeightOfIOSNativePanel(e.height,function(e){
...
if(!this.state.show){
if(this.$mask.css("display",""),mmversion.isIOS){
JSAPI.invoke("handleMPPageAction",{
action:"opInputAccessoryView",
show:!1
},function(){});
var t=0;
Device.os.getNumVersion()<13&&(t=this.state.keyboardHeight?(window.innerHeight+this.state.keyboardHeight-this.$inputWrapper.offset().height)/2:window.innerHeight-this.$inputWrapper.offset().height),
this.$inputWrapper.css({
opacity:0,
bottom:t,
...
var e=this.inputEle.value.length;
this.inputEle.setSelectionRange(e,e);
}
