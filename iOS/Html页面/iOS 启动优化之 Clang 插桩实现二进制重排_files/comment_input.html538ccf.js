...
define("pages_new/common_share/video/lifecycle_manager.js",["biz_wap/utils/ajax.js","common/utils.js","biz_wap/jsapi/core.js","pages_new/modules/utils/url.js","pages/video_collection/report.js"],function(e){
"use strict";
function n(e){
"function"==typeof e&&m.push(e);
}
function o(e){
...
function s(e){
o(e.init),n(e.destroy),t(e.getData),"function"==typeof e.init&&e.init(!0);
}
function f(e,n){
y&&n&&!S[n]&&l({
type:"GET",
...
timeout:2e3,
success:function(o){
console.info("[Lifecycle Manager] Preload PageData",n,e);
try{
S[n]=JSON.parse(o);
}catch(t){
console.error("[Lifecycle Manager] Parse Preload PageData Failed",n,e,t);
}
S[n]&&S[n].video_page_info&&"string"==typeof S[n].video_page_info.cover_url&&((new Image).src=S[n].video_page_info.cover_url);
}
});
}
function u(e,n){
if(!w){
if(w=!0,console.info("[Lifecycle Manager] Start to switch to",e),_.leaveReportNowForSwitchVideo(),
!y)return void g.loadNewPageKeepingHistoryStackIfSecOpen(e);
var o=_extends({},p.getParams(location.href),p.getParams(e)),t=3e3,s=2,f=0,u=null;
i();
var m=function(){
if(f===s)if(u&&u.base_resp&&0===u.base_resp.ret){
S={};
var n=p.getParams(location.href);
c(u,n),a(),w=!1,console.info("[Lifecycle Manager] Finish to switch to",e);
}else g.loadNewPageKeepingHistoryStackIfSecOpen(e);
},h=setTimeout(function(){
g.loadNewPageKeepingHistoryStackIfSecOpen(e);
},t),v=function j(e){
document.removeEventListener("WeixinJSBridgeAuthChanged",j),console.info("[Lifecycle Manager] GetA8Key Success",e.state),
history.replaceState(null,"",e.fullUrl),clearTimeout(h),delete window.__second_open__,
f++,m();
};
document.addEventListener("WeixinJSBridgeAuthChanged",v),history.replaceState(null,"",e);
var P=function L(){
document.removeEventListener("WeixinJSBridgeSpaHistoryChanged",L),console.info("[Lifecycle Manager] History Stack Changed"),
d.invoke("doAuthCurrentUrl",{},function(e){
e&&e.err_msg&&-1!==e.err_msg.indexOf(":ok")&&console.info("[Lifecycle Manager] Invoke GetA8Key Success",e);
});
};
document.addEventListener("WeixinJSBridgeSpaHistoryChanged",P),n&&S[n]?(console.info("[Lifecycle Manager] Get Cache PageData",n),
u=S[n],c(u,o),r(u),f++,m()):l({
type:"GET",
url:e,
async:!1,
timeout:2e3,
success:function(n){
console.info("[Lifecycle Manager] Get PageData");
try{
u=JSON.parse(n);
}catch(t){
console.error("[Lifecycle Manager] Parse PageData Failed",e,t);
}
u&&(c(u,o),r(u)),f++,m();
},
error:function(){
...
var l=e("biz_wap/utils/ajax.js"),g=e("common/utils.js"),d=e("biz_wap/jsapi/core.js"),p=e("pages_new/modules/utils/url.js"),_=e("pages/video_collection/report.js"),y=!1,m=[],h=[],v=[],w=!1,S={};
return{
register:s,
openNewVideoPage:u,
preloadNewVideoPageData:f
};
});function _typeof(e){
